            ...
            <table id="stripe-table" class="theme-table invoice-table">
              ...
              <tbody>
                ...
                $k=0;
                  ...
                  $sql="SELECT * FROM posts WHERE user_id='$user_id' && status='0'";
               ...
               while ($row=mysqli_fetch_assoc($result)) {
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a href="in_review_company_post.php?deleteid=<?php echo $row['p_id']; ?>" id="btnGetTime"  class="fa fa-trash-o input_btn"  style="    color: red;"></a>
