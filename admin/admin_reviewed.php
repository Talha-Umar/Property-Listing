...
if (isset($_REQUEST['unapprove'])) {
  $id=$_REQUEST['unapprove'];
 $sql="UPDATE posts SET status='0' WHERE  p_id='$id'";
       if (mysqli_query($conn, $sql)) {
        echo "<script type='text/javascript'>location.replace('admin_reviewed.php')</script>";
       } 
          ...
          <div class="table-holder">
            ...
            <table id="stripe-table" class="theme-table invoice-table">
              ...
              <tbody>
               ...
               while ($row=mysqli_fetch_assoc($result)) {
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a href="admin_reviewed.php?delete=<?php echo $row['p_id']; ?>" id="btnGetTime" title="Delete" class="fa fa-trash-o input_btn"  style="color: red;"></a> |
                        
                      <a href="admin_reviewed.php?unapprove=<?php echo $row['p_id']; ?>" id="input_btn_inactive" title="Unapprove" class="fa fa-times-circle input_btn_inactive" style="color: green;"></a> 
               ...
               <?php } } else {?>
              <tr>
                <td>Thers is no approved post</td>
              </tr>
