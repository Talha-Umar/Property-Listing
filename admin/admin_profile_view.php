  ...
  $password=$_POST['password'];
   $sql1="UPDATE users SET password='$password' WHERE id='$user_id'  ";
    if (mysqli_query($conn,$sql1)) {
     ...
     echo "<script type='text/javascript'>location.replace('admin_profile_view.php')</script>";
    }
}
...
<head>
  ...
  <title>Property Listing-Profile</title>
...
<div class="container">   
            ...
            <div class="inner">
              ...
              <div class="row profile-data">
               ...
               if ($imgpath != null && $imgpath != "" && $img!="" && $img!= null)
                  ...
                  <!-- Send Message Start -->
                  <div class="send-msg">
                   <a href="admin_edit_profile.php"> <button class="btn btn-sm btn-default" type="button">Edit Profile</button></a>
                  </div>
                  <!-- Send Message End -->
                ...
                <span><?php echo $row['name']; ?></span>
                  ...
                  <ul class="icon-list">
                    ...
                    <li><i class="fa fa-clock-o"></i>
                     <span><?php echo $row['created_at']; ?></span></li>
                      
                  </ul>
                     <br/>
                     <h3  class="fa fa-key">
                <span>Change Password Here</span>

                  </h3>
            <form action="admin_profile_view.php" method="post">
  ...
  <?php include 'footer.php'; ?>
      <script>
         ...
         $("#ContentPlaceHolder1_TextBox1").bind("keypress", function (event) {
             if (event.charCode != 0) {
