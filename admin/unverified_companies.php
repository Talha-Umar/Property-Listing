...
if (isset($_REQUEST['deleteid'])) {
 ...
 $sql="DELETE FROM users WHERE id='$id'";
      if (mysqli_query($conn, $sql)) {
        echo "<script type='text/javascript'>location.replace('unverified_companies.php')</script>";
      }
...
if (isset($_REQUEST['verifyid'])) {
 ...
 $sql="UPDATE company_agency SET verified_status='1' WHERE id ='$id'";
  if (mysqli_query($conn, $sql)) {
       echo "<script type='text/javascript'>location.replace('unverified_companies.php')</script>";
  }
  else {echo "Error: " . $sql . "<br>" . mysqli_error($conn);}
          ...
          <div class="header">
            <ul>
              <li>
                  ...
                  <i class="fa fa-envelope"></i> Un-Verified
            ...
            <table id="stripe-table" class="theme-table  ">
              ...
              <tbody>
                ...
                $k=0;
                  ...
                  $sql="SELECT * FROM company_agency WHERE verified_status='0'";
               ...
               while ($row=mysqli_fetch_assoc($result)) {
                ...
                <tr>
                 ...
                 <td>
                    ...
                    <span class="delayed">Un-Verified</span>
                     <?php } ?>
                 ...
                 <td>
                      ...
                      <a href="unverified_companies.php?deleteid=<?php echo $row['id'] ?>"  id="btnGetTime"   class="fa fa-trash-o input_btn"  style=" color: red;" title="Remove Company"></a>
                       
                       <?php if ($row['verified_status']=='0') { ?>    
                     | <a href="unverified_companies.php?verifyid=<?php echo $row['id'] ?>" id="activenow"  class="fa fa-check-circle input_btn_active" style="color: green;" title="Verify Company"></a> 
                         <?php } ?>
              ...
              <?php } } else{?>
              <tr>
                <td>Thers is no Unverified Company</td>
              </tr>
