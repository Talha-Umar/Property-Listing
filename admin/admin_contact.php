...
$sql1=" DELETE FROM admin_contact_us  WHERE id='$id'";
    if (mysqli_query($conn,$sql1)) {
     echo'<script type="text/javascript">alert("Message Deleted...!");</script>';
     echo "<script type='text/javascript'>location.replace('admin_contact.php')</script>";
    }
...
<div class="container">   
  ...
  <?php
            $k=0;
                $sql="SELECT * FROM admin_contact_us";
             ...
             ?>
                <tr>
                      ...
                      <td class="hidden-sm hidden-xs"><?php echo $row['subject']; ?></td>
